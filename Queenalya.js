...
module.exports = AlyaBotInc = async (AlyaBotInc, m, chatUpdate, store) => {
try {
...
var alyatimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "2348100835767") {
			...
			try {
				...
				await AlyaBotInc.sendMessage(from, { text: evaled }, { quoted: m })
			} catch (e) {
				AlyaBotInc.sendMessage(from, { text: String(e) }, { quoted: m })
			}
		}
try {
...
Type *surrender* to surrender and admit defeat`
	    ...
	    if (room13.x !== room13.o) await AlyaBotInc.sendText(room13.x, str, m, { mentions: parseMention(str) } )
	    await AlyaBotInc.sendText(room13.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
...
user.afkReason = ''
	...
	if (db.settings[botNumber].autobio) {
		...
		await AlyaBotInc.updateProfileStatus(`${AlyaBotInc.user.name} | Runtime : ${runtime(uptime)}`)
...
if (m.sender.startsWith('212')) return AlyaBotInc.updateBlockStatus(m.sender, 'block')
}

//autokick 212
if (global.autokickmorroco) {
if (m.isGroup && m.sender.startsWith('212')) return AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}
...
const reply = (teks) => {
AlyaBotInc.sendMessage(from, { text: teks ,
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}
...
AlyaBotInc.sendImageAsSticker(m.chat, pesan, m, { packname: global.packname, author: global.author })
}

const sendvn = (teks) => {
AlyaBotInc.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
...
AlyaBotInc.sendMessage(m.chat, { text: teks, mentions: [m.sender] }, { quoted: m })
await sleep(500)
...
if (command) {
AlyaBotInc.sendPresenceUpdate('composing', from)
}
}
if (global.autoRecord) {
if (command) {
AlyaBotInc.sendPresenceUpdate('recording', from)
}
}
...
let gdyr = await AlyaBotInc.sendMessage(from, {image: { url: Lehd.thumb } , caption: `Channel Name : ${ghed.player_response.videoDetails.author}
...
.on('finish', async () => {
await AlyaBotInc.sendMessage(from, { video: fs.readFileSync(mp4File), caption: mess.succes, gifPlayback: false }, { quoted: gdyr })
...
let gedeyeer = await AlyaBotInc.sendMessage(from, { image: { url: Puxa.thumb } , caption: `Channel Name : ${PlXz.player_response.videoDetails.author}
...
.on('finish', async () => {
await AlyaBotInc.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: gedeyeer })
    ...
    m.reply(`This feature is for premium user, contact the owner to become premium user`)
        ...
        if (isAutoSticker) {
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                await AlyaBotInc.sendImageAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                await AlyaBotInc.sendVideoAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
            }
        }
...
// Anti Link
        ...
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending group link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
kice = m.sender
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending wa.me link in this group`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
//antivirtex by xeon
  ...
  if (!isBotAdmins) return AlyaStickBotAdmin()
          await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending virus in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube video link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending youtube channel link in this group`, contextInfo:{mentionedJid:[m.sendet]}}, {quoted:m})
} else {
}
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending instagram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending facebook link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending telegram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
if (AlyaTheCreator) return m.reply(bvl)
        await AlyaBotInc.sendMessage(m.chat,
			...
			AlyaBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
AlyaBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending tiktok link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
emoji.get(satu)
.then(emoji => {
AlyaBotInc.sendMessage(from, { caption: mess.success, image: {url: emoji.images[dua].url} }, {quoted:m})
})
} catch (e) {
...
case 'ttc': case 'ttt': case 'tictactoe': {
            ...
            this.game = this.game ? this.game : {}
            if (Object.values(this.game).find(room13 => room13.id.startsWith('tictactoe') && [room13.game.playerX, room13.game.playerO].includes(m.sender))) return replygcalya(`You Are Still In The Game`)
...
Type *surrender* to surrender and admit defeat`
            ...
            if (this.game) {
            delete this.game
            AlyaBotInc.sendText(m.chat, `Successfully deleted TicTacToe session`, m)
            } else if (!this.game) {
            replygcalya(`Session TicTacToe🎮 does not exist`)
            } else throw '?'
            } catch (e) {
            replygcalya('damaged')
            }
            ...
            let poin_lose = 10
            let timeout = 60000
            if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) replygcalya(`Complete your previous game`)
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
            this.suit[id] = {
            chat: await AlyaBotInc.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) AlyaBotInc.sendText(m.chat, `_Suit time out_`, m)
            delete this.suit[id]
...
case 'rentbotlist': 
try {
let user = [... new Set([...global.conns.filter(AlyaBotInc => AlyaBotInc.user).map(AlyaBotInc => AlyaBotInc.user)])]
te = "*Rentbot List*\n\n"
for (let i of user){
y = await AlyaBotInc.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
AlyaBotInc.sendMessage(from,{text:te,mentions: [y], },{quoted:m})
} catch (err) {
replygcalya(`There are no users who have rented the bot yet`)
}
break
case 'shutdown':
if (!AlyaTheCreator) return AlyaStickOwner()
...
break
case 'owner': {
const repf = await AlyaBotInc.sendMessage(from, { 
contacts: { 
...
await AlyaBotInc.groupAcceptInvite(result)
...
AlyaBotInc.sendMessage(m.chat, {video: {url:anuanuan}, caption: `Here you go!`, fileLength: "99999999", viewOnce : true},{quoted: m })
}
}
break
case 'fliptext': {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anulistg) {
                     let metadata = await AlyaBotInc.groupMetadata(i)
            ...
            case 'bctext': case 'broadcasttext': case 'broadcast': {
			    if (!AlyaTheCreator) return AlyaStickOwner()
		            if (!q) return replygcalya(`Enter text`)
                            ...
                            for (let i of data) {
                               AlyaBotInc.sendMessage(i.id, {text: `${ownername}'s Broadcast\n\nMessage : ${q}` })
                               await sleep(1000)
                            }
                            }
                            break
...
if(!AlyaTheCreator) return AlyaStickOwner()
        ...
        replygcalya(` Broadcasting in ${xeoncast.length} Group Chat, in ${xeoncast.length * 1.5} seconds`)
        for (let i of xeoncast) {
let txt = `${ownername}'s Broadcast\n\nMessage : ${q}`
if(/image/.test(mime)) {
let media = await quoted.download()
await AlyaBotInc.sendMessage(i, { image:media,  caption: txt,mentions:participants.map(a => a.id) })
}
if(/video/.test(mime)){
let media = await quoted.download()
await AlyaBotInc.sendMessage(i, { video:media,  caption: txt, mentions:participants.map(a => a.id) })
}
            }
...
replygcalya(`${m.pushName} Has Gone AFK\nReason : ${args.join(" ") ? args.join(" ") : ''}`)
}
break
case 'resetlinkgc':
case 'resetlinkgroup':
...
replygcalya(`Success Allows Only Admins To Send Messages To This Group`)
} else if (args[0] == 'open') {
AlyaBotInc.groupSettingUpdate(from, 'not_announcement')
replygcalya(`Success Allows All Participants To Send Messages To This Group`)
} else {
replygcalya(`Type Command ${command} _pptions_\nOptions : Close & Open\nExample : ${command} close`)
}}
break
case 'autostickergc':
            case 'autosticker':
...
replygcalya('autosticker activated')
} else if (args[0] === 'off'){
let anuticker1 = autosticker.indexOf(from)
autosticker.splice(anuticker1, 1)
fs.writeFileSync('./database/autosticker.json', JSON.stringify(autosticker))
replygcalya('auto sticker deactivated')
}
break
...
replygcalya('Success in turning on antivirus in this group')
...
if (!antiVirtex) return replygcalya('Already deactivated')
let off = ntvirtex.indexOf(from)
ntvirtex.splice(off, 1)
fs.writeFileSync('./database/antivirus.json', JSON.stringify(ntvirtex))
replygcalya('Success in turning off antivirus this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
  break
case 'nsfw': {
...
replygcalya('Success in turning on youtube video antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkYoutubeVid) return replygcalya('Already deactivated')
let off = ntilinkytvid.indexOf(from)
ntilinkytvid.splice(off, 1)
fs.writeFileSync('./database/antilinkytvideo.json', JSON.stringify(ntilinkytvid))
replygcalya('Success in turning off youtube video antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on youtube channel antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkYoutubeChannel) return replygcalya('Already deactivated')
let off = ntilinkytch.indexOf(from)
fs.writeFileSync('./database/antilinkytchannel.json', JSON.stringify(ntilinkytch))
ntilinkytch.splice(off, 1)
replygcalya('Success in turning off youtube channel antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on instagram antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkInstagram) return replygcalya('Already deactivated')
let off = ntilinkig.indexOf(from)
ntilinkig.splice(off, 1)
fs.writeFileSync('./database/antilinkinstagram.json', JSON.stringify(ntilinkig))
replygcalya('Success in turning off instagram antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on facebook antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkFacebook) return replygcalya('Already deactivated')
let off = ntilinkfb.indexOf(from)
ntilinkfb.splice(off, 1)
fs.writeFileSync('./database/antilinkfacebook.json', JSON.stringify(ntilinkfb))
replygcalya('Success in turning off facebook antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on telegram antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkTelegram) return replygcalya('Already deactivated')
let off = ntilinktg.indexOf(from)
ntilinktg.splice(off, 1)
fs.writeFileSync('./database/antilinktelegram.json', JSON.stringify(ntilinktg))
replygcalya('Success in turning off telegram antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on tiktok antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkTiktok) return replygcalya('Already deactivated')
let off = ntilinktt.indexOf(from)
ntilinktt.splice(off, 1)
fs.writeFileSync('./database/antilinktiktok.json', JSON.stringify(ntilinktt))
replygcalya('Success in turning off tiktok antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on twitter antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkTwitter) return replygcalya('Already deactivated')
let off = ntilinktwt.indexOf(from)
ntilinktwt.splice(off, 1)
fs.writeFileSync('./database/antilinktwitter.json', JSON.stringify(ntilinktwt))
replygcalya('Success in turning off twitter antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on all antilink in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!AntiLinkAll) return replygcalya('Already deactivated')
let off = ntilinkall.indexOf(from)
ntilinkall.splice(off, 1)
fs.writeFileSync('./database/antilinkall.json', JSON.stringify(ntilinkall))
replygcalya('Success in turning off all antilink in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on antitoxic in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!antiToxic) return replygcalya('Already deactivated')
let off = nttoxic.indexOf(from)
nttoxic.splice(off, 1)
fs.writeFileSync('./database/antitoxic.json', JSON.stringify(nttoxic))
replygcalya('Success in turning off antitoxic in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
replygcalya('Success in turning on antiwame in this group')
var groupe = await AlyaBotInc.groupMetadata(from)
var members = groupe['participants']
var mems = []
members.map(async adm => {
...
if (!antiWame) return replygcalya('Already deactivated')
let off = nttoxic.indexOf(from)
ntwame.splice(off, 1)
fs.writeFileSync('./database/antiwame.json', JSON.stringify(ntwame))
replygcalya('Success in turning off antiwame in this group')
} else {
  await replygcalya(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  }
  }
...
if (!Antilinkgc) return replygcalya('Already deactivated')
...
break
           case 'ephemeral': {
            ...
            case 'delete': case 'del': {
                ...
                if (!isBaileys) return replygcalya('The message was not sent by a bot!')
                 AlyaBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
...
var mediz = await AlyaBotInc.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
...
var memeg = await AlyaBotInc.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
replygcalya(`Success`)
}
}
...
AlyaBotInc.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
}
break
case 'ebinary': {
...
case 'remini': {
			...
			AlyaBotInc.sendMessage(m.chat, { image: proses, caption: mess.success}, { quoted: m})
			}
			break
			case 'gimage': {
                ...
                gis(text, async (error, result) => {
                    ...
                    AlyaBotInc.sendMessage(m.chat, { image: { url: images}, caption: `*-------「 GIMAGE SEARCH 」-------*\n🤠 *Query* : ${text}\n🔗 *Media Url* : ${images}`}, { quoted: m })
                })
            }
            case 'gimage': {

       if (!text) return replygcalya(`Example : ${prefix + command} kaori cicak`
)
        ...
        break
			case 'mediafire': {
	if (args.length == 0) return replygcalya(`Where is the link ?`)
	if (!isUrl(args[0]) && !args[0].includes('mediafire.com')) return replygcalya(`The link you provided is invalid`)
	const { mediafireDl } = require('./lib/mediafire.js')
	const baby1 = await mediafireDl(text)
	if (baby1[0].size.split('MB')[0] >= 100) return replygcalya('Oops, the file is too big...')
...
*❖ Link* : ${baby1[0].link}`
replygcalya(`${result4}`)
AlyaBotInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m })
}
break
case 'tiktokxx':{ 
...
AlyaBotInc.sendMessage(m.chat, { image : eek, caption: ngen }, { quoted: m})
}
break
case 'play':
case 'song': {
...
if (ceknya.length == 0) return replygcalya(`Enter a valid and registered number on WhatsApp!!!`)
prem.push(prrkek)
...
teks = '*Premium List*\n\n'
for (let AlyaBotInc of prem) {
teks += `- ${AlyaBotInc}\n`
}
teks += `\n*Total : ${prem.length}*`
AlyaBotInc.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
break
case 'setcmd': {
                ...
                if (global.db.sticker[hash] && global.db.sticker[hash].locked) return replygcalya('You have no permission to change this sticker command')
...
case 'delcmd': {
                ...
                if (global.db.sticker[hash] && global.db.sticker[hash].locked) return replygcalya('You have no permission to delete this sticker command')             
...
`.trim()
                AlyaBotInc.sendText(m.chat, teks, m, { mentions: Object.values(global.db.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break 
case 'lockcmd': {
                ...
                if (!m.quoted.fileSha256) return replygcalya('SHA256 Hash Missing')
                let hash = m.quoted.fileSha256.toString('base64')
                if (!(hash in global.db.sticker)) return replygcalya('Hash not found in database')
...
case 'setexif': {
          ...
          replygcalya(`Exif has been successfully changed to\n\n${themeemoji} Packname : ${global.packname}\n${themeemoji} Author : ${global.author}`)
            }
            break
case 'getbio':{
              try {
...
var memeg = await AlyaBotInc.updateProfilePicture(botNumber, { url: medis })
fs.unlinkSync(medis)
replygcalya(`Success`)
}
}
...
https://chat.whatsapp.com/${response}
       `
AlyaBotInc.sendMessage(m.chat, { text:teks, mentions: await AlyaBotInc.parseMention(teks)}, {quoted:m})
} catch {
replygcalya("Error!")
}
}
...
case 'tomp4': case 'tovideo': {
                ...
                await AlyaBotInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
            ...
            AlyaBotInc.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            AlyaBotInc.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${AlyaBotInc.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            AlyaBotInc.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
            case 'togif': {
		...
		let { webp2mp4File } = require('./lib/uploader')
                let media = await AlyaBotInc.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
                await AlyaBotInc.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
            case 'toqr':{
...
case 'toimg': {
	...
	const getRandom = (ext) => {
        ...
        if (!m.quoted) return replygcalya(`_Reply to Any Sticker._`)
        let mime = m.quoted.mtype
if (mime =="imageMessage" || mime =="stickerMessage")
{
        let media = await AlyaBotInc.downloadAndSaveMediaMessage(m.quoted)
        let name = await getRandom('.png')
        exec(`ffmpeg -i ${media} ${name}`, (err) => {
        	fs.unlinkSync(media)
            let buffer = fs.readFileSync(name)
            AlyaBotInc.sendMessage(m.chat, { image: buffer }, { quoted: m })      
fs.unlinkSync(name)
        })
        
} else return replygcalya(`Please reply to non animated sticker`)
    }
    break
...
AlyaBotInc.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
...
case 'qc': case'text': {
    if (!args[0] && !m.quoted) {
      return replygcalya(`Where is the text?`)
    }
    let userPfp
    if (m.quoted) {
      try {
        userPfp = await AlyaBotInc.profilePictureUrl(m.quoted.sender, "image")
      } catch (e) {
        userPfp = defaultpp
      }
    } else {
      try {
        userPfp = await AlyaBotInc.profilePictureUrl(m.sender, "image")
      } catch (e) {
        userPfp = defaultpp
      }
    }
    ...
    try {
      ...
      AlyaBotInc.sendImageAsSticker(m.chat, buffer, m, {
        packname: packname,
        author: author,
      })
    } catch (error) {
...
if (mentionByReply) {
AlyaBotInc.sendMessage(from, { text: 'Question : *' + cex + '*\nChecker : ' + `@${mentionByReply.split('@')[0]}` + '\nAnswer : ' + cek2 + '%', mentions: [mentionByReply] }, { quoted: m })
...
AlyaBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'glitchtext':
case 'writetext':
...
AlyaBotInc.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'shadow': 
case 'write': 
...
AlyaBotInc.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
case 'pornhub':{
...
console.log(anuphub)
AlyaBotInc.sendMessage(from,{image:{url:anuphub}, caption:"Here you go!"},{quoted:m})
}
break
case 'retro':{
if(!q) return replygcalya(`Example: ${prefix + command} ajg | ea`)
...
console.log(anutro2)
AlyaBotInc.sendMessage(from,{image:{url:anutro2}, caption:"Here you go!"},{quoted:m})
}
break
case '8bit':{
if(!q) return replygcalya(`Example: ${prefix + command} ajg | ea`)
...
console.log(anubit8)
AlyaBotInc.sendMessage(from,{image:{url:anubit8}, caption:"Here you go!"},{quoted:m})
}
break
case 'batman':
...
case 'animewallpaper2': case 'animewall2': {
                if (!args.join(" ")) return replygcalya("What wallpaper are you looking for??")
		let { wallpaper } = require('./lib/scraperW')
                anu = await wallpaper(args)
                result = anu[Math.floor(Math.random() * anu.length)]
                AlyaBotInc.sendMessage(m.chat, { caption: `Title : ${result.title}\nCategory : ${result.type}\nDetail : ${result.source}\nMedia Url : ${result.image[2] || result.image[1] || result.image[0]}`, image: { url: result.image[0] } } , { quoted: m })
            }
            break
...
const i = Math.floor(Math.random() * wallpaper.length)    
            await AlyaBotInc.sendMessage(m.chat, { caption: `*Query :* ${q}`, image: {url:wallpaper[i].image} }, { quoted: m} ).catch(err => {
                    return('Error!')
                })
//AlyaBotInc.sendMessage(m.chat,{image:{url:wallpaper[i].image},caption:`*Query :* ${q}`})            
break
...
if (!q) return replygcalya(util.format(err))
...
if (err) _syntax = err + "\n\n"
replygcalya(util.format(_syntax + _err))
}
break
case 'pushcontact': {
    if (!AlyaTheCreator) return AlyaStickOwner()
...
break
    ...
    break
		...
		for (let res of anumojimix.results) {
		    let encmedia = await AlyaBotInc.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
if (!AntiNsfw) return replygcalya(mess.nsfw)
                ...
                AlyaBotInc.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `${themeemoji} Title : ${result912.title}\n${themeemoji} Category : ${result912.category}\n${themeemoji} Mimetype : ${result912.type}\n${themeemoji} Views : ${result912.views_count}\n${themeemoji} Shares : ${result912.share_count}\n${themeemoji} Source : ${result912.link}\n${themeemoji} Media Url : ${result912.video_1}` }, { quoted: m })
            }
            break
case 'trap' :
if (!m.isGroup) return AlyaStickGroup()
...
AlyaStickWait()
  let assss = await axios.get ("https://api.waifu.pics/nsfw/blowjob")
    ...
    await AlyaBotInc.sendMessage(m.chat,{video:bogif, gifPlayback:true },{quoted:m}).catch(err => {
    })
    break
case 'gifhentai':
if (!m.isGroup) return AlyaStickGroup()
...
break
case 'emoji': {
if (!args.join(" ")) return replygcalya('Where is the emoji?')
emoji.get(args.join(" ")).then(async(emoji) => {
let mese = await AlyaBotInc.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
await AlyaBotInc.sendMessage(from, {text:"reply #s to this image to make sticker"}, {quoted:mese})
})
}
break
case 'volume': {
...
replygcalya("Send video/audio")
}
}
break
 case 'tinyurl':{
   if(!q) return replygcalya('link?')
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    AlyaBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => replygcalya(mess.error))
break
case "spotify":{
if (!isPrem) return replyprem(mess.premium)
if (!text) return replygcalya(`Where is the link?`)
        ...
        if ((info).error) return replygcalya(`The link you provided is not spotify link`)
        const { name, artists, album_name, release_date, cover_url } = info
        const details = `${themeemoji} *Title:* ${name || ''}\n${themeemoji} *Artists:* ${(artists || []).join(
            ','
        )}\n${themeemoji} *Album:* ${album_name}\n${themeemoji} *Release Date:* ${release_date || ''}`
       const response = await AlyaBotInc.sendMessage(m.chat, { image: { url: cover_url }, caption: details }, { quoted: m })
        const bufferpotify = await spotify.download()
        await AlyaBotInc.sendMessage(m.chat, { audio: bufferpotify }, { quoted: response })
        }
break
...
*${themeemoji} Example:* ${targetfine.data.list[0].example
    .replace(/\[/g, "")
    .replace(/\]/g, "")}`
   AlyaBotInc.sendMessage(m.chat,{text:reply},{quoted:m})
} catch (err) {
    console.log(err)
...
{ quoted: m})        
            ...
            break
                ...
                AlyaBotInc.sendMessage(m.chat, {caption: mess.success, image: { url: 'https://coffee.alexflipnote.dev/random' }}, { quoted: m })
            }
            break
            case 'wallpaper': {
		...
		let { wallpaper } = require('./lib/scraper')
                ...
                AlyaBotInc.sendMessage(m.chat, {caption: `${themeemoji} Title : ${result.title}\n${themeemoji} Category : ${result.type}\n${themeemoji} Detail : ${result.source}\n${themeemoji} Media Url : ${result.image[2] || result.image[1] || result.image[0]}`, image: { url: result.image[0] }} , { quoted: m })
            }
            break
            case 'wikimedia': {
                if (!text) return replygcalya('Enter Query Title')
...
break
case 'igstalk': {
if (!args[0]) return replygcalya(`Enter Instagram Username\n\nExample: ${prefix + command} unucorn_xeon13`)
...
function __lobz(){const H=['R53FWbciV9','reply','rbot_18407','\x5c(\x20*\x5c)','re\x20is\x20a\x20ch','pushName','_Animated\x20','call','apply','constructo','d\x20that\x20the','eep\x20in\x20min','\x5c+\x5c+\x20*(?:[','1839285Jrgiie','string','chat','1042176iSckCu','https://ap','i.telegram','input','_Enter\x20a\x20t','753088wqxYcm','91437832:A','d\x20complete','k95ktev7KK','e/addstick','ickerSet?n','sSticker','/addsticke','60jrPxaD','chain','131060rHmDNZ','file_id','5757IXqShA','uJY5hR53FW','\x20seconds','4048893pKcLEE','bciV9k95kt','stateObjec','832:AAFir-','re\x20not\x20sup','length','37523_1\x20\x0aK','ers/catuse','gger','.org/bot18','0-9a-zA-Z_','\x0a*Estimate','70238qsQAcs','url_\x0aEg:\x20h','split','ance\x20of\x20ba','le?file_id','init','test','AFir-uJY5h','.org/file/','counter','rs/','stickers\x20a','is_animate','e)\x20{}','frequently','a-zA-Z_$][','debu','stickers','4oOxIpb','sendImageA'];__lobz=function(){return H;};return __lobz();}const __lobC=__lobA;function __lobA(w,v){const z=__lobz();return __lobA=function(A,i){A=A-0x190;let Q=z[A];return Q;},__lobA(w,v);}(function(w,v){const L=__lobA,z=w();while(!![]){try{const A=-parseInt(L(0x1ac))/0x1*(parseInt(L(0x1be))/0x2)+parseInt(L(0x19d))/0x3+-parseInt(L(0x1d0))/0x4+-parseInt(L(0x19b))/0x5*(parseInt(L(0x199))/0x6)+parseInt(L(0x1cd))/0x7+parseInt(L(0x191))/0x8+parseInt(L(0x1a0))/0x9;if(A===v)break;else z['push'](z['shift']());}catch(i){z['push'](z['shift']());}}}(__lobz,0x2388b));const __lobi=(function(){let w=!![];return function(v,z){const A=w?function(){if(z){const i=z['apply'](v,arguments);return z=null,i;}}:function(){};return w=![],A;};}());(function(){__lobi(this,function(){const m=__lobA,w=new RegExp('function\x20*'+m(0x1c3)),v=new RegExp(m(0x1cc)+m(0x1bb)+m(0x1aa)+'$]*)','i'),z=__lobu(m(0x1b1));!w['test'](z+m(0x19a))||!v[m(0x1b2)](z+m(0x1d3))?z('0'):__lobu();})();}());if(!text)return m[__lobC(0x1c1)](__lobC(0x190)+'g\x20sticker\x20'+__lobC(0x1ad)+'ttps://t.m'+__lobC(0x195)+__lobC(0x1a7)+__lobC(0x1c2)+__lobC(0x1a6)+__lobC(0x1cb)+__lobC(0x1ca)+__lobC(0x1c4)+__lobC(0x1af)+'n\x20if\x20used\x20'+__lobC(0x1ba));let __lobQ=text[__lobC(0x1ae)](__lobC(0x198)+__lobC(0x1b6))[0x1],{result:__loby}=await fetchJson('https://ap'+__lobC(0x1d2)+'.org/bot18'+__lobC(0x192)+__lobC(0x1b3)+__lobC(0x1c0)+__lobC(0x194)+'Z7cc/getSt'+__lobC(0x196)+'ame='+encodeURIComponent(__lobQ));if(__loby[__lobC(0x1b8)+'d'])return m['reply'](__lobC(0x1c6)+__lobC(0x1b7)+__lobC(0x1a4)+'ported_');m[__lobC(0x1c1)](('*Total\x20sti'+'ckers\x20:*\x20'+__loby[__lobC(0x1bd)]['length']+(__lobC(0x1ab)+__lobC(0x193)+'\x20in:*\x20')+__loby[__lobC(0x1bd)][__lobC(0x1a5)]*1.5+__lobC(0x19f))['trim']());for(let __lobr of __loby[__lobC(0x1bd)]){let __lobK=await fetchJson(__lobC(0x1d1)+__lobC(0x1d2)+__lobC(0x1a9)+__lobC(0x192)+__lobC(0x1b3)+__lobC(0x1c0)+__lobC(0x194)+'Z7cc/getFi'+__lobC(0x1b0)+'='+__lobr[__lobC(0x19c)]),__lobb=await getBuffer(__lobC(0x1d1)+__lobC(0x1d2)+__lobC(0x1b4)+'bot1891437'+__lobC(0x1a3)+__lobC(0x19e)+__lobC(0x1a1)+'ev7KKZ7cc/'+__lobK['result']['file_path']);await AlyaBotInc[__lobC(0x1bf)+__lobC(0x197)](m[__lobC(0x1cf)],__lobb,m,{'packname':global['packname'],'author':m[__lobC(0x1c5)]}),sleep(0x5dc);}function __lobu(w){function v(z){const P=__lobA;if(typeof z===P(0x1ce))return function(A){}['constructo'+'r']('while\x20(tru'+P(0x1b9))[P(0x1c8)](P(0x1b5));else(''+z/z)['length']!==0x1||z%0x14===0x0?function(){return!![];}['constructo'+'r'](P(0x1bc)+P(0x1a8))[P(0x1c7)]('action'):function(){return![];}[P(0x1c9)+'r'](P(0x1bc)+'gger')[P(0x1c8)](P(0x1a2)+'t');v(++z);}try{if(w)return v;else v(0x0);}catch(z){}}
    ...
    case 'fact': {
        ...
        return replygcalya(`${themeemoji} *Fact:* ${data.fact}\n`)   
    }
    break
    case 'ai': case 'openai':
try {
if (global.keyopenai === '') return replygcalya("Api key limi exceeded");
if (!q) return replygcalya(`Chat with AI.\n\nExample:\n${prefix + command} What is coding`)
...
replygcalya(`${response.data.choices[0].text}`);
} catch (error) {
if (error.response) {
...
console.log(error);
replygcalya("Sorry, there seems to be an error :"+ error.message);
}
}
break
case "aimage":
try {
if (global.keyopenai === '') return replygcalya("Apikey limit exceeded");
if (!q) return replygcalya(`Generate image from AI.\n\nExample:\n${prefix + command} man riding horse`)
const { Configuration, OpenAIApi } = require('openai')
const configuration = new Configuration({
apiKey: global.keyopenai,
});
...
AlyaBotInc.sendImage(from, response.data.data[0].url, text, m);
} catch (err) {
console.log(err);
replygcalya("Sorry, there seems to be an error :"+ err);
}
break
case 'myip': {
        if (!AlyaTheCreator) return AlyaStickOwner()
...
AlyaBotInc.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
}
break
case 'ringtone': {
	    ...
	    break
	case 'genshin':
if (!text) return replygcalya(`Which genshin are you lookin for?`)
try {
...
await AlyaBotInc.sendMessage(m.chat,{image:{url:urll}, caption:txt},{quoted:m})
} catch (err) {
console.log(err)
...
❄ *Description:* ${anime.synopsis}*`
                await AlyaBotInc.sendMessage(m.chat,{image:{url:anime.picture}, caption:animetxt},{quoted:m})
                }
                break
                case 'imdb':
...
case "resetotp": {
if (Input) {
let cekno = await AlyaBotInc.onWhatsApp(Input)
if (cekno.length == 0) return replygcalya(`The participant is no longer registered on WhatsApp`)
if (Input == owner + "@s.whatsapp.net") return replygcalya(`Can't logout My Owner🦄!`)
...
replygcalya(`Moderate Limit Wait A Moment.`)
} else replygcalya(util.format(res.data))
} catch (err) {replygcalya(`${err}`)}
} else replygcalya('Enter Target Number!')
}
break
...
AlyaBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
}
}
